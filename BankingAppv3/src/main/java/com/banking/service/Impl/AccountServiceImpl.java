...
public class AccountServiceImpl implements AccountService {
	...
	public Account getById(int accountId) {
		...
		return accountrepo.findById(accountId)
				.orElseThrow(() -> new ResourceNotFoundException("Bank account with id" + accountId + "is not fount")
	...
	@Override
	public void updateAccountContactDetail(AccountContacDetailtDto accountContactDetailDto) {
		// TODO Auto-generated method stub
